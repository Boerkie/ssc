...
public class RewardNetworkTests {
	...
	/**
	 * Testing the RewardNetworkImpl.
	 */
	private RewardNetwork rewardNetwork;

	@Before
	public void setUp() {
		// Create the test configuration for the application from
		// TestInfrastructureConfig that now also includes the RewardsConfig:
	...
	// Test copied from sping-intro project
